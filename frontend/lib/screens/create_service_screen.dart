  ...
  Future<void> _submit() async {
    ...
    if (widget.isEditing) {
      ...
      final err = await context
          ...
          .update(widget.editServiceId!, data);
      if (!mounted) return;
      if (err != null) {
      ...
      body: SafeArea(
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final hPad = isWide
                ? ((constraints.maxWidth - 700) / 2).clamp(20.0, 200.0)
                : 20.0;
                ...
                children: [
                  ...
                  DropdownButtonFormField<int>(
                    ...
                    onChanged: (v) {
                      setState(() {
                        _selectedDeptId = v;
                        _selectedDeptName = _departments.firstWhere(
                            (d) => d['id'] == v,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: OutlinedButton.icon(
                          ...
                          icon: const Icon(Icons.calendar_today, size: 16),
                          label: Text(
                              _endAt != null ? _formatDt(_endAt!) : 'Λήξη'),
                        ),
                      ),
                    ],
                  ),
                    ...
                    child: Wrap(
                      ...
                      children: [
                        _hourCard(
                            ...
                            label: 'Υπηρεσία',
                            subtitle: 'Ώρες υπηρεσίας'),
                        _hourCard(
                            ctrl: _hoursVolCtrl,
                            icon: Icons.volunteer_activism,
                            color: AppColors.emerald500,
                            label: 'Εθελοντικές',
                            subtitle: 'Ώρες εθελοντισμού'),
                        _hourCard(
                            ctrl: _hoursTrainingCtrl,
                            icon: Icons.school_rounded,
                            color: AppColors.violet500,
                            label: 'Επανεκπαίδευση',
                            subtitle: 'Ώρες ως εκπαιδευόμενος'),
                        _hourCard(
                            ctrl: _hoursTrainersCtrl,
                            icon: Icons.co_present,
                            color: AppColors.amber500,
                            label: 'Εκπαιδευτές',
                            subtitle: 'Ώρες ως εκπαιδευτής'),
                        _hourCard(
                            ctrl: _hoursTEPCtrl,
                            icon: Icons.local_hospital_rounded,
                            color: AppColors.red500,
                            label: 'ΤΕΠ',
                            subtitle: 'Ώρες τμήματος επειγόντων'),
                      ],
                    ),
                  ),
